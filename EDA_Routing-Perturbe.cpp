...
#define BEAMWIDTH 4//邻域1参数
#define Maxdepth 5 //邻域1参数
#define Max_kdepth 5//邻域1参数
#define SHORTESTROB 0.8//邻域2参数
#define ADJUSTRATIO 0.2//邻域3参数
	...
	/*for (int x = 0; x < numNet; x++)
	{
		if (net_delay[x] > temp_net_delay)
		{
			...
			for (int y = 0; y < Current[x].sink_num; y++)
			{
				...
				if (Current[x].path_delay[y] > temp_net_delay)
				{
